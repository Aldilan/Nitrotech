...
<head>
	...
	<link rel="stylesheet" type="text/css" href="hapus.css">
</head>
<body>
<div class="container">
	...
	<center><div class="pengguna">
				...
				<div class="headkat">
					<table>
						...
						<tr>
							...
							<td></td>
							<td class="dlt"><a href="hapusN.php?id=<?php echo $row['id_barang'];?>"><button><img src="../../../img/edit/edit 3/hapus.png"></button></a></td>
						</tr>
					</table>
				</div>
			</center>
		...
		<?php for ( $i = 1; $i <= $jh; $i++) : ?>
			<?php if ($i == $ha) : ?>
				<a href="?nama=<?= $nama; ?>&psad=<?= $psad; ?>&halaman=<?= $i; ?>" style="font-weight: bold; color : white;"><?= $i; ?></a>
			<?php else : ?>
